...
//							chatPngNum = result.data.length;
							...
							canvasChat:for (var i = 0; i < result.data.length; i++) {
								...
								var chatShow = '<div id="chatPng'+i+'" sytle="top: '+i*0.005+'rem; left: '+i*0.05+'rem;" class="chatShow"><div class="userPic"><img id="atvPic" src="'+ result.data[i].avatar_large +'" class="clip-circle user chatPng" /></div><div class="chatContent">'+ result.data[i].screen_name + ' : ' + result.data[i].msg +'</div></div>'
